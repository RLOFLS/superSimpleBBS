...
<div class="content">
	<table>	
		<tr class="intro">
			<td width="70px">类型</td><td width="170px" class="title">帖子标题</td><td width="70px">作者</td><td width="70px">浏览</td><td width="70px">评论</td><td width="170px">时间</td><td width="100px" colspan="2">操作</td>
		</tr>
