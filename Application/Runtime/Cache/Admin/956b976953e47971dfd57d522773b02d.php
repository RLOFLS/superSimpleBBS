...
<div class="content">
	<form action="" method="post">
		...
		<div class="input-group">
  			...
  			<input type="text" name="from_someone" class="form-control" value="<?php echo (session('admin_name')); ?>" readonly>
		</div>
		<div class="textarea">
  			<textarea class="form-control" name="content" rows="12"></textarea>
		</div>
		<div class="handle">
			<input type="submit" name="submit" value="发送" class="btn btn-success">
