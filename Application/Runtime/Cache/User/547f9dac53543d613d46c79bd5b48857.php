...
<div class="content">
	<table>	
		<tr class="intro">
			<td width="100px">状态</td><td width="220px" class="title">邮件标题</td><td width="100px">发件人</td><td width="170px"><span class="info">时间&nbsp;</span></td><td width="100px" colspan="2">操作</td>
		</tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="/index.php/user/email/look/id/<?php echo ($vol["email_id"]); ?>/status/<?php echo ($vol["status"]); ?>/b/1"><button type="button" class="btn btn-default">关闭</button></a>
      </div>
    </div>
  </div>
</div>
