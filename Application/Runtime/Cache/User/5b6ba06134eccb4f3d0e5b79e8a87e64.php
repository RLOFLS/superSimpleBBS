...
<div class="content">
	<table>	
		<tr class="intro">
			<td width="100px">状态</td><td width="150px" class="title">邮件标题</td><td width="100px">收件人</td><td width="100px">发件人</td><td width="170px"><span class="info">时间&nbsp;</span></td><td width="100px" colspan="2">操作</td>
		</tr>
